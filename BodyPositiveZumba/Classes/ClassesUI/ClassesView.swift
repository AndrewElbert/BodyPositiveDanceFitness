...
struct ClassesView: View {
    ...
    var body: some View {
        ...
        Text("We offer multiple daily classes designed to fit any schedule and accommodate all fitness levels!")
            ...
            AnyView(
                DanceClassCard(danceClass: danceClass)
                    .overlay(
                        RoundedRectangle(cornerRadius: 15)
                            .stroke(
                                isCurrentCard ? danceClass.color : Color.clear,
